...
> 🌍 **International & Intercultural Orientation**
...
* Expert Interview to Industry 5.0
* World of work 2030
...
<div style="display:flex; gap:22px; align-items:stretch; margin-top:18px;">
  ...
  <div style="flex:0 0 38%; border-radius:18px; padding:22px; color:#ffffff;
    ...
    <div style="margin-top:18px; padding:14px 16px; border-radius:14px;
      ...
      <div style="font-size:16px; opacity:.95;">Competence orientation</div>
      <div style="font-size:20px; font-weight:700; margin-top:6px;">
        Theory, practice and reflection combined
      </div>
    </div>
...
<div style="display:flex; gap:22px; align-items:stretch; margin-top:18px;">
  ...
  <div style="flex:0 0 40%; border-radius:18px; padding:24px; color:#ffffff;
    ...
    <div style="margin-top:14px; font-size:36px; font-weight:800; line-height:1.15;">
      Future-Oriented VET
    </div>

    <div style="margin-top:18px; padding:16px 18px; border-radius:14px;
                background: rgba(255,255,255,.18); border: 1px solid rgba(255,255,255,.28);">
      <div style="font-size:18px; font-weight:700;">
        VET&nbsp;6.0 · Industry&nbsp;4.0 · Industry&nbsp;5.0
      </div>
    </div>
...
✅ **Kick-off: Source analysis / Expert interview (Industry 4.0 & 5.0)**  
The event begins with a source analysis or expert interview on Industry 4.0 and 5.0.

➡️ **Derive requirements for VET 6.0**  
This analysis serves as a basis for deriving the requirements for modern vocational education and training (VET 6.0).

💬 **Discuss and continue into project work**  
The results are discussed in the seminar and used for further project work.
...
>Presentation of projects and discussion of results. Reflection on the suitability of the chosen project methods and their transferability to real educational contexts